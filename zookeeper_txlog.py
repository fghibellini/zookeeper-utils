...
class TxLogReader:
    ...
    def tx_crc_test(self, expected_crc_val, data_len):
        ...
        print(f"tx_end_marker: {tx_end_marker}")
    ...
    with open(file_path, 'rb') as file:
        ...
        while True:
            ...
            if tx_type == TxOpCodes.ERROR.value:
                ...
                # TODO how come there is no digest here but there is in the other tx_types?!
                ...
                tx_digest = txlog_reader.read_long('tx_digest')
                txlog_reader.skip(1) # end of transaction marker 0x42
                tx = {
                    'type': 'SET_DATA',
                    'path': path,
...
read_zookeeper_txlog("/Users/fghibellini/Downloads/log.95e000ebfc3")